...
using Project.Admin.Models.Install;
using Project.Core;
...
public partial class InstallController : Controller
{
    ...
    public virtual async Task<IActionResult> Index(InstallModel model)
    {
        ...
        try
        {
            ...
            var cultureInfo = new CultureInfo(ProjectCommonDefaults.DefaultLanguageCulture);
            var regionInfo = new RegionInfo(ProjectCommonDefaults.DefaultLanguageCulture);
            ...
            return View(new InstallModel { RestartUrl = Url.RouteUrl("InstallationRestartApplication") });
        }
