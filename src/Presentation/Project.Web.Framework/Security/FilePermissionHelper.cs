...
namespace Project.Web.Framework.Security;
...
public static class FilePermissionHelper
{
    ...
    [SupportedOSPlatform("windows")]
    private static bool CheckPermissionsInWindows(IProjectFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// <param name="checkDelete">Check delete</param>
    /// <returns>Result</returns>
    public static bool CheckPermissions(this IProjectFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetDirectoriesWrite(this IProjectFileProvider fileProvider)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetFilesWrite(this IProjectFileProvider fileProvider)
    {
        return new List<string>
        {
            fileProvider.MapPath(ProjectConfigurationDefaults.AppSettingsFilePath)
        };
    }
