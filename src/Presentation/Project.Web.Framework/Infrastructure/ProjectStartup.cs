...
using Project.Services.CoursePrice;
using Project.Services.DailyTask;
...
using Project.Services.Payment;
...
using Project.Services.Syllabus;
...
public partial class ProjectStartup : IProjectStartup
{
    ...
    public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ICandidateBatchEnrollementService, CandidateBatchEnrollementService>();
        services.AddScoped<ISyllabusService, SyllabusService>();
        services.AddScoped<IPhonePeService, PhonePeService>();
        //services.AddScoped<IPhonePePaymentOrchestrator, PhonePePaymentOrchestrator>();
        services.AddScoped<ICertificateService, CertificateService>();
        services.AddScoped<ICoursePriceService, CoursePriceService>();
