...
namespace Project.Web.Framework.Infrastructure.Mapper.Extensions;
...
public static class MappingExtensions
{
    ...
    public static List<TModel> ToModel<TModel>(this IEnumerable<BaseEntity> entity) where TModel : BaseModel
    {
        ArgumentNullException.ThrowIfNull(entity);

        return entity.Map<List<TModel>>();
    }
    ...
    /// <returns>Mapped model</returns>
    public static TModel ToConfigModel<TModel>(this IConfig config) where TModel : BaseModel, IConfigModel
    {
    ...
    public static TConfig ToConfig<TConfig, TModel>(this TModel model, TConfig config)
        where TConfig : class, IConfig where TModel : BaseModel, IConfigModel
    {
        ArgumentNullException.ThrowIfNull(model);
