...
public partial class CommonHelper
{
    ...
    /// <summary>
    /// Get integer list from string
    /// </summary>
    /// <param name="value">Value</param>
    /// <returns>Result string</returns>
    public static List<long> GetLongListFromString(string value)
    {
    ...
    public static void SetProperty(object instance, string propertyName, object value)
    {
        ...
        var pi = instanceType.GetProperty(propertyName)
                 ?? throw new ProjectException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);

        if (!pi.CanWrite)
            throw new ProjectException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
