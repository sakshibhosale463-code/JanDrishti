...
/// </summary>
public partial class ProjectEngine : IEngine
{
    #region Utilities
    ...
    public virtual object ResolveUnregistered(Type type)
    {
        ...
        foreach (var constructor in type.GetConstructors())
            try
            {
                ...
                {
                    var service = Resolve(parameter.ParameterType) ?? throw new ProjectException("Unknown dependency");
                    return service;
                });
        ...
        throw new ProjectException("No constructor was found that had all the dependencies satisfied.", innerException);
    }
