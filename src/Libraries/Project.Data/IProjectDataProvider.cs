...
/// </summary>
public partial interface IProjectDataProvider
{
    #region Methods
    ...
    /// </returns>
    Task<TEntity> InsertWithoutIdentityAsync<TEntity>(TEntity entity) where TEntity : BaseEntity;
    ...
    /// <param name="entities">Collection of Entities</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task BulkInsertWithoutIdentityEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity;
    ...
    string BuildConnectionString(IProjectConnectionStringInfo nopConnectionString);
