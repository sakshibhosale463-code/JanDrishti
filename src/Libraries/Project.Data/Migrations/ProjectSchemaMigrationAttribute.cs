...
///</remarks>
public partial class ProjectSchemaMigrationAttribute : ProjectMigrationAttribute
{
    /// <summary>
    ...
    public ProjectSchemaMigrationAttribute(string dateTime, string description,
