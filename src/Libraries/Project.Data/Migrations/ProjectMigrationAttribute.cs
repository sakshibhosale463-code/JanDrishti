...
/// </summary>
public partial class ProjectMigrationAttribute : MigrationAttribute
{
    #region Fields
    ...
    public ProjectMigrationAttribute(string dateTime, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
    ...
    /// <param name="targetMigrationProcess">The target migration process</param>
    public ProjectMigrationAttribute(string dateTime, string description, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        this(new MigrationConfig
        {
            DateTime = dateTime,
    ...
    /// <param name="targetMigrationProcess">The target migration process</param>
    public ProjectMigrationAttribute(string dateTime, string nopVersion, UpdateMigrationType updateMigrationType, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        this(new MigrationConfig
        {
            DateTime = dateTime,
    ...
    protected ProjectMigrationAttribute(MigrationConfig config) : base(config.Version, config.Description)
    {
        _config = config;
    }
        ...
        public virtual long Version
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(DateTime))
                    throw new ProjectException("One of the following properties must be initialized: either Version or DateTime");

                var version = System.DateTime
                    .ParseExact(DateTime, ProjectMigrationDefaults.DateFormats, CultureInfo.InvariantCulture).Ticks;
        ...
        public virtual string Description
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(NopVersion))
                    throw new ProjectException("One of the following properties must be initialized: either Description or NopVersion");

                if (UpdateMigrationType.HasValue)
                    description = string.Format(ProjectMigrationDefaults.UpdateMigrationDescription, NopVersion, UpdateMigrationType.ToString());
