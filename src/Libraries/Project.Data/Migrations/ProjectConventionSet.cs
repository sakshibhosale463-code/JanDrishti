...
/// </summary>
public class ProjectConventionSet : IConventionSet
{
    #region Ctor

    public ProjectConventionSet(IProjectDataProvider dataProvider)
    {
