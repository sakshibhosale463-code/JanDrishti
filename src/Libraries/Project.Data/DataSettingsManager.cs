...
public partial class DataSettingsManager
{
    ...
    /// <returns>Data settings</returns>
    public static DataConfig LoadSettings(IProjectFileProvider fileProvider = null, bool reload = false)
    {
        ...
        var filePath_json = fileProvider.MapPath(ProjectDataSettingsDefaults.FilePath);
        var filePath_txt = fileProvider.MapPath(ProjectDataSettingsDefaults.ObsoleteFilePath);
    ...
    /// <param name="fileProvider">File provider</param>
    public static void SaveSettings(DataConfig dataSettings, IProjectFileProvider fileProvider)
    {
        AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
