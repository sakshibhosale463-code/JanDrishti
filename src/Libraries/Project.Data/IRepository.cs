...
public partial interface IRepository<TEntity> where TEntity : BaseEntity
{
    ...
    /// The entity entry
    /// </returns>
    TEntity GetById(long? id, Func<ICacheKeyService, CacheKey> getCacheKey = null, bool includeDeleted = true);
    ...
    /// <param name="publishEvent">Whether to publish event notification</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task InsertWithoutIdentityAsync(TEntity entity, bool publishEvent = true);
    ...
    /// <param name="publishEvent">Whether to publish event notification</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task InsertWithoutIdentityAsync(IList<TEntity> entities, bool publishEvent = true);
    ...
    /// get datatable
    /// </summary>
    /// <param name="resetIdentity">datatable</param>
    /// <returns>A task that represents the asynchronous operation</returns>
