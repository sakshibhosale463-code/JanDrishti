...
/// </summary>
public partial class MsSqlNopDataProvider : BaseDataProvider, IProjectDataProvider
{
    #region Utilities
    ...
    public virtual Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity
    {
        ...
        var tableName = ProjectMappingSchema.GetEntityDescriptor(typeof(TEntity)).EntityName;
    ...
    /// </summary>
    protected override IDataProvider LinqToDbDataProvider => SqlServerTools.GetDataProvider(SqlServerVersion.v2017, SqlServerProvider.MicrosoftDataSqlClient);
