...
namespace Project.Services.ExportImport.Help;
...
public partial class PropertyManager<T>
{
    ...
    public PropertyManager(IEnumerable<PropertyByName<T>> defaultProperties, CatalogSettings catalogSettings, IEnumerable<PropertyByName<T>> localizedProperties = null)
    {
