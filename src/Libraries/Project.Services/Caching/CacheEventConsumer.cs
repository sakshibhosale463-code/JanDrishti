...
namespace Project.Services.Caching;
    ...
    where TEntity : BaseEntity
{
    ...
    {
        await RemoveByPrefixAsync(ProjectEntityCacheDefaults<TEntity>.ByIdsPrefix);
        await RemoveByPrefixAsync(ProjectEntityCacheDefaults<TEntity>.AllPrefix);

        if (entityEventType != EntityEventType.Insert)
            await RemoveAsync(ProjectEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
