...
public partial class LocalizedEntityService : ILocalizedEntityService
{
    ...
    {
        var key = _staticCacheManager.PrepareKeyForDefaultCache(ProjectLocalizationDefaults.LocalizedPropertiesCacheKey,
    ...
    public virtual async Task<string> GetLocalizedValueAsync(long languageId, long entityId, string localeKeyGroup, string localeKey)
    {
        if (_localizationSettings.LoadAllLocalizedPropertiesOnStartup)
        {
            ...
            var localizedValues = await _staticCacheManager.GetAsync(
                _staticCacheManager.PrepareKeyForDefaultCache(ProjectLocalizationDefaults.LocalizedPropertyLookupCacheKey, languageId),
        ...
        //gradual loading
        var key = _staticCacheManager.PrepareKeyForDefaultCache(ProjectLocalizationDefaults.LocalizedPropertyCacheKey
