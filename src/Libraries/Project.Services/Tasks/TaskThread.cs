...
namespace Project.Services.Tasks
{
    ...
    public partial class TaskThread : IDisposable
    {
        ...
        static TaskThread()
        {
            ...
            _scheduleTaskUrl = $"{commonConfig.DomainUrl.TrimEnd('/')}/{NopTaskDefaults.ScheduleTaskPath}";
            _timeout = commonConfig.ScheduleTaskRunTimeout;
        }
        ...
        private async System.Threading.Tasks.Task RunAsync()
        {
            ...
            foreach (var taskName in _tasks.Keys)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // Resolve
                    var logger = EngineContext.Current.Resolve<Logging.ILogger>(scope);
                    ...
                    message = string.Format(await localizationService.GetResourceAsync("ScheduleTasks.Error"), taskName,
                        message, taskType, string.Empty, _scheduleTaskUrl);
