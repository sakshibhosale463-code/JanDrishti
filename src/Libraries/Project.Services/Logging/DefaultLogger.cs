...
namespace Project.Services.Logging;
...
public partial class DefaultLogger : ILogger
{
    ...
    protected virtual Log PrepareLog(LogLevel logLevel, string shortMessage, string fullMessage = "", User user = null)
    {
        return new Log
        {
            LogLevel = logLevel,
    ...
    /// A task that represents the asynchronous operation
    /// </returns>
    public virtual async Task InsertLogAsync(LogLevel logLevel, string shortMessage, string fullMessage = "", User user = null)
    {
        //check ignore word/phrase list?
        if (IgnoreLog(shortMessage) || IgnoreLog(fullMessage))
            return;

        await _logRepository.InsertAsync(PrepareLog(logLevel, shortMessage, fullMessage, user), false);
    }
    ...
    public virtual void InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", User user = null)
    {
        ...
        _logRepository.Insert(PrepareLog(logLevel, shortMessage, fullMessage, user), false);
    }
