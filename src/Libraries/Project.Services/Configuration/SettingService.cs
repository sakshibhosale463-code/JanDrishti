...
namespace Project.Services.Configuration;
...
public partial class SettingService : ISettingService
{
    ...
    protected virtual async Task SetSettingAsync(Type type, string key, object value, bool clearCache = true)
    {
        ...
        var settingForCaching = allSettings.TryGetValue(key, out var settings) ? settings.FirstOrDefault() : null;
    ...
    {
        await _staticCacheManager.RemoveByPrefixAsync(ProjectEntityCacheDefaults<Setting>.Prefix);
    }
    ...
    {
        _staticCacheManager.RemoveByPrefix(ProjectEntityCacheDefaults<Setting>.Prefix);
    }
